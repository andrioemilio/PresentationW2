...
- The Landsat 5 Thematic Mapper (TM) was a breakthrough in Earth observation, offering high-resolution imagery across seven spectral bands
- It had Enabled detailed analysis of the planet's surface for over 28 years, 
- Very versatile in applications for example environmental monitoring & improved spatial resolution for detailed observations
- Gives an extensive data record crucial for long-term change analysis. 
- Required substantial data storage and processing capabilities, limited thermal band resolution
- 16-day revisit cycle could miss rapid environmental changes. 
- TM's legacy played a significant contribution in understanding of Earth's natural and human-made environments.
